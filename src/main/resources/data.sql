...
INSERT INTO question_required_links (old_id, segment_state_id, question_id, question_required)
...
INSERT INTO segment_screen_entrypoint_links (layer_id, old_id, segment_id, entrypoint_id, screen_id, screen_position)
...
INSERT INTO screen_question_links (old_id, segment_screen_entrypoint_id, question_id, question_position, question_visibility)
VALUES (NULL, 1, 1, 1, 'SHOW'),           -- 1
       (NULL, 1, 1, 1, 'HIDE'),           -- 2
       (NULL, 1, 1, 1, 'SHOW_PREFILLED'), -- 3
       (NULL, 1, 1, 1, 'HIDE_PREFILLED'), -- 4
...
INSERT INTO segment_state_links (layer_id, old_id, segment_id, state)
VALUES (2, NULL, 2, 'ACTIVE'), -- 2
       (2, 1, 1, 'ARCHIVE'); -- 3

INSERT INTO question_required_links (old_id, segment_state_id, question_id, question_required)
VALUES (NULL, 2, 7, TRUE),   -- 7
       (NULL, 2, 8, FALSE),  -- 8
       (NULL, 2, 9, TRUE),   -- 9
...
INSERT INTO screen_question_links (old_id, segment_screen_entrypoint_id, question_id, question_position, question_visibility)
VALUES (NULL, 10, 1, 1, 'SHOW'),           -- 26
       (NULL, 10, 1, 1, 'HIDE'),           -- 27
       (NULL, 10, 1, 1, 'SHOW_PREFILLED'), -- 28
       (NULL, 10, 1, 1, 'HIDE_PREFILLED'), -- 29
...
INSERT INTO segment_state_links (layer_id, old_id, segment_id, state)
VALUES (3, NULL, 3, 'ACTIVE'), -- 4
       (3, 1, 1, 'ACTIVE'),    -- 5
       (3, 2, 2, 'ARCHIVE'); -- 6

INSERT INTO question_required_links (old_id, segment_state_id, question_id, question_required)
VALUES (NULL, 4, 7, TRUE),   -- 13
       (NULL, 4, 8, FALSE),  -- 14
       (3, 4, 9, FALSE),     -- 15
...
INSERT INTO segment_screen_entrypoint_links (layer_id, old_id, segment_id, entrypoint_id, screen_id, screen_position)
VALUES -- (3, NULL, 2, 1, 1, 1), -- 10 это из прошлого слоя должно прийти
       -- (3, NULL, 2, 1, 2, 2), -- 11 это из прошлого слоя должно прийти
       -- (3, NULL, 2, 1, 5, 3), -- 12 это из прошлого слоя должно прийти
       (3, 13, 2, 1, 4, 5), -- 20
       (3, 14, 2, 1, 3, 4), -- 21

       (3, 15, 2, 2, 2, 2), -- 15
       (3, 16, 2, 2, 1, 1); -- 16
--        (3, NULL, 2, 2, 3, 3), -- 17 это из прошлого слоя должно прийти
--        (3, NULL, 2, 2, 4, 4), -- 18 это из прошлого слоя должно прийти
--        (3, NULL, 2, 2, 5, 4); -- 19 это из прошлого слоя должно прийти

INSERT INTO screen_question_links (old_id, segment_screen_entrypoint_id, question_id, question_position, question_visibility)
VALUES (26, 10, 1, 1, 'SHOW_PREFILLED'),           -- 26
       (27, 10, 1, 1, 'HIDE_PREFILLED'),           -- 27
