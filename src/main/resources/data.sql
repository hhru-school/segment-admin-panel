...
VALUES ('Разряд не ниже 4', 'Разряд не ниже 4', 'DYNAMIC', 'ACTIVE', '{1, 2, 3}'),                                     --1
       ...
       ('Наличие образования', 'Заполнение информации об образовании', 'STATIC', 'ARCHIVE', '{1, 4, 5}'),              --5
       ('Основная информация', 'Заполнение основной информации', 'STATIC', 'ARCHIVE', '{1, 4, 5}'); --6
