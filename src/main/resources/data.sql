...
VALUES        ('Опыт работы, лет','Опыт работы на аналогичной должности, указанный в годах','QUESTION', 'SINGLE_CHOICE',  '{1, 2, 3, 7}'), --1
              ...
              ('Работали ли на других управляющих должностях','Работали ли на других управляющих должностях','QUESTION', 'SINGLE_CHOICE',  '{9, 10}'), --18                                                                                                                        --18
              ('Величина компании, в которой вы работали','Величина компании, в которой вы работали','QUESTION', 'SINGLE_CHOICE',  '{29, 30, 31, 32}'),  --19                                                                                                                       --19
              ...
              ('Доводилось ли работать в международных компаниях', 'Доводилось ли работать в международных компаниях','QUESTION','SINGLE_CHOICE',  '{36, 37}'),--22                                                                                                                        --22
              ...
              ('Технологический стэк','Перечень технологий, которыми умеет пользоваться кандидат','QUESTION', 'MULTI_SELECT',  '{19, 20, 21, 22, 41, 42, 43}'); --25
...
INSERT INTO segments (parent_segment_id,create_time,title,description,role,tag)
VALUES (NULL,'2023-02-12 02:02:00', 'Программист, разработчик', 'Разработчик программного обеспечения', '{96}', '{"Programmer", "Software", "IT"}'), -- 1
       ...
       (4,'2023-02-12 02:02:00', 'Телохранитель', 'Телохранитель, унаследован от охранника', '{90}', '{"Bodyguard", "Security", "PrivateProtection"}'), --6
