...
VALUES ('Разряд не ниже 4', 'Разряд не ниже 4', 'DYNAMIC', 'ACTIVE', '{1, 2, 3}'),                                     --1
       ...
       ('Ios 2.2', 'Просто Архивный', 'STATIC', 'DISABLE', '{4}'),                                                     --9                                       --7
       ('Ios 1.0', 'Просто Архивный', 'STATIC', 'DISABLE', '{6}'),                                                     --9                                       --7
       ('Ios 1.10', 'Просто Архивный', 'STATIC', 'DISABLE', '{7}'),                                                    --9                                       --7
       ('Ios 10.01', 'Просто Архивный', 'STATIC', 'DISABLE', '{8}'),                                                   --9                                       --7
       ('Ios 10.10', 'Просто Архивный', 'STATIC', 'DISABLE', '{9}'),                                                   --9                                       --7
       ('Ios 20.4', 'Просто Архивный', 'STATIC', 'DISABLE', '{10}'),                                                   --10                                  --7
       ('Ios 100.11', 'Просто Архивный', 'STATIC', 'DISABLE', '{11}'); --11
