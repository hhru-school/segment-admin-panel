...
VALUES ('WEB', 'Экраны для платформы WEB','{1}','ARCHIVE'),  --1
       ('WEB', 'Экраны для платформы WEB','{7,4}','ACTIVE'),  --2
       ('IOS', 'Экраны для платформы IOS','{5,2}','ACTIVE'),  --3
       ('Android', 'Экраны для платформы Android','{6,3}','ACTIVE');  --4
...
INSERT INTO segments (layer_id,parent_segment_id,old_segment_id,title,description,role,tag)
VALUES (1,NULL,NULL, 'Программист, разработчик', 'Разработчик программного обеспечения', '{96}', '{"Programmer", "Software", "IT"}'); -- 1
...
INSERT INTO segments (layer_id,parent_segment_id,old_segment_id,title,description,role,tag)
VALUES (2,NULL,NULL, 'Переводчик', 'Переводчик', '{93}', '{"Translator", "ForeignLanguages"}'); --2


INSERT INTO question_required_links (layer_id,old_id,segment_id,application_id,question_id,question_required)
VALUES (2,NULL,2,2,3,TRUE), -- 7
       (2,NULL,2,3,3,TRUE), -- 8
       (2,NULL,2,4,3,TRUE), -- 9

       (2,NULL,2,2,4,TRUE), -- 10
       (2,NULL,2,3,4,TRUE), -- 11
       (2,NULL,2,4,4,TRUE); -- 12
...
INSERT INTO segments (layer_id,parent_segment_id,old_segment_id,title,description,role,tag)
VALUES (3,2,NULL, 'Переводчик с китайского', 'Переводчик, владеющмя китайским языком, унаследован от переводчика', '{93}','{"Translator", "Chinese"}'),                                                --3
       (3,NULL,NULL, 'Охранник', 'Охранник', '{90}', '{"Security", "Safety", "Guard"}'), --4
       (3,1,NULL, 'Java-разработчик', 'Разработчик серверной части приложений на языке Java', '{96}','{"Java", "Backend", "Programmer", "Software", "IT"}'); --5
...
VALUES (3,NULL,3,1,2,3,1,1,'SHOW'), -- 25
       ...
       (3,NULL,5,2,2,4,9,2,'SHOW'), --
       (3,NULL,5,1,3,4,9,2,'SHOW'), --
       (3,NULL,5,2,3,4,9,2,'SHOW'), --
       (3,NULL,5,1,4,4,9,2,'SHOW'), --
       (3,NULL,5,2,4,4,9,2,'SHOW'); --
