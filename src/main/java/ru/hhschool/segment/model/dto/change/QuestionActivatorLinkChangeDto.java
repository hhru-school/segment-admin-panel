...
public class QuestionActivatorLinkChangeDto {
    ...
    public QuestionActivatorLinkChangeDto(Long id, boolean questionRequired, QuestionVisibilityType questionVisibility, String entrypointTitle, String segmentTitle, String questionTitle) {
        this.id = id;
