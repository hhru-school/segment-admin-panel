...
public class Question implements Serializable {
    ...
    public Question(Long id, String title, String description, QuestionType type, boolean required, QuestionVisibilityType questionVisibilityType, List<Long> possibleAnswerIdList, Long layerId, boolean resumeField) {
        this.id = id;
        this.title = title;
