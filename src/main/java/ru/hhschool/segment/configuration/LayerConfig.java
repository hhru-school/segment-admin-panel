...
public class LayerConfig {
  @Bean
  public LayerService getLayerService(LayerDao layerDao, PlatformDao platformDao, QuestionDao questionDao, SegmentStateLinkDao segmentStateLinkDao) {
    return new LayerService(layerDao, platformDao, questionDao, segmentStateLinkDao);
  }
